...
当前公开版本先专注做好生图 prompt 和 LOOK 迁移。接下来会持续支持更新，包括但不限于：
...
如果你想持续跟进这个项目，欢迎点一个 Star，我会专注更新这个方向。

## Star 和关注

如果你把这个 skill 用进自己的 Agent 工作流，欢迎给项目点一个 Star。我会围绕电影级生图、视频 prompt 和 Agent 工作流持续更新。
